...
function bindServicePopup(){
  ...
  document.querySelectorAll('.vendor-detail-btn').forEach(btn=>btn.addEventListener('click',()=>openByName(btn.dataset.service)));
  openServiceFromQuery(openByName);
